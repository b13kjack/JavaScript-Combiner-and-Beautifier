...
# Path to the JavaScript directory, can be hardcoded below or provided as a command line argument eg. python jscb.py.py C:\js_chunks
js_directory = ""
...
# If not provided in command line nor hardcoded, raise an exception 
    ...
    print(r"No directory provided. Please provide a directory as a command line argument (eg. python jscb.py C:\js_chunks) or hardcode it in the script.")
    sys.exit(1)
